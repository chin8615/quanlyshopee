<?php
        ...
        foreach($_SESSION['cart'] as $cart_item) {
            if($cart_item['id'] != $id) {
                $product[] = array('tensanpham'=>$cart_item['tensanpham'], 'id'=>$cart_item['id'],'soluong'=>$cart_item['soluong'], 
                        'giasanpham'=>$cart_item['giasanpham'], 'gia_discount'=>$cart_item['gia_discount'], 'hinhanh'=>$cart_item['hinhanh'], 'masanpham'=>$cart_item['masanpham']);
    ...
    if(isset($_POST['themgiohang'])) {
        ...
        if($row) {
            ...
            'giasanpham'=>$row['giasanpham'],'gia_discount'=>$row['gia_discount'], 'hinhanh'=>$row['hinhanh'], 'masanpham'=>$row['masanpham']));
